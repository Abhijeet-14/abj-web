  ...
  return (
    <div id="home" className="pb-5 smooth-scroll">
      ...
      >
        <Navbar.Brand
          href="#home"
          className="justify-content-flex-start mr-5"
        ...
        <Navbar.Toggle aria-controls="basic-navbar-nav" onClick={toggleMenu}>
          {!menu ? (
            <img src={Menu3} alt="Menu" css={{ height: 35, width: 35 }} />
          ) : (
            <img src={Cross3} alt="Menu" css={{ height: 35, width: 35 }} />
          )}
        </Navbar.Toggle>
        <Navbar.Collapse
          id="basic-navbar-nav"
